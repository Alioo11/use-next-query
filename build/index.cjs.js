...
const useNextQuery = (schema, options) => {
    ...
    const [queryUpdateList, setQueryUpdateList] = React.useState([]); // TODO fixType
    const paramObserver = React.useMemo(() => new QueryParamObserver(), []);
    const _initialState = React.useRef(initialState);
